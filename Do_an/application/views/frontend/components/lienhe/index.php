	...
	<div class="container">
		...
		<div class="col-md-4 col-12">
			...
			<ul class="list-unstyled">
				<li class="clearfix">
					<i class="fa fa-map-marker fa-1x" style="color:#000; padding: 20px; "></i>
					<span style="color: black"> Hai Bà Trưng, Hà Nội</span><br>
				</li>
				<li class="clearfix">
					<i class="fa fa-phone fa-1x" style="color:#000;padding: 20px;  "></i>
					<span style="color: black">(0123) 456 789</span>
				</li>
				<li class="clearfix">
					<i class="fa fa-envelope fa-1x " style="color:#000; padding: 20px; "></i>
					<span style="color: black"><a href="#">sieuthigiuongda.vn</a></span>
				</li>
			</ul>
		</div>
