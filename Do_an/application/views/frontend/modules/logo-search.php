    ...
    <div class="col-xs-12 col-sm-12 col-md-5 col-lg-5 search">
      <div class="contact-row">
        <div class="phone inline">
          <i style="color: #934D28;" class="icon fa fa-phone"></i> (0123) 456 789
        </div>
        <div class="contact inline">
          <i style="color: #934D28;" class="icon fa fa-envelope"></i> sieuthigiuongda.vn
        </div>
      </div>
      <form action="search" method="get" role="form">
        <div class="input-search">
          <input style="border: 1px solid #934D28;" type="text" class="form-control" id="search_text" name="search" placeholder="Nhập từ khóa để tìm kiếm...">
          <button style="background-color:#934D28;">
