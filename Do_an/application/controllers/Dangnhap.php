...
class Dangnhap extends CI_Controller {
    ...
    public function dangnhap(){
        ...
        if($this->form_validation->run() ==TRUE){
            ...
            $this->data['title']='SieuThiGiuongGa - Đăng nhập tài khoản';
            $this->data['view']='dangnhap';
            $this->load->view('frontend/layout',$this->data);
        }     
    }
    ...
    public function dangky(){
        ...
        if($this->form_validation->run() ==TRUE){
            ...
            $config['smtp_user']    = 'gamepad.center@gmail.com';
            ...
            $this->email->from('gamepad.center@gmail.com', 'SieuThiGiuongGa');
            $this->email->to($email);
            $this->email->subject('Hệ thống SieuThiGiuongGa - Quà thành viên mới');
            $this->email->message('Bạn đã trở thành thành viên mới của cửa hàng SieuThiGiuongGa, Cửa hàng tặng bạn 1 mã giảm giá giảm 100.000 đ : '.$tempcoupon.' , Mã này có giá trị tới ngày '.$tempdatelimit.'
        ...
        $this->data['title']='SieuThiGiuongGa - Đăng ký tài khoản';   
    ...
    public function forget_password(){
        ...
        if($this->form_validation->run() ==TRUE){
            ...
            $config['validation'] = TRUE;   
            $this->email->initialize($config);
            $this->email->from('gamepad.center@gmail.com', 'Smart Store');
            $this->email->to($list['email']);
            $this->email->subject('Hệ thống SieuThiGiuongGa - Lấy lại mật khẩu');
        ...
        $this->data['title']='SieuThiGiuongGa - Quên mật khẩu';   
    ...
    public function reset_password_new($id){
        ...
        if($this->form_validation->run() ==TRUE){ 
           ...
           if($this->Mcustomer->customer_check_id_email($id, $email)!=FALSE){
            ...
            $this->data['title']='SieuThiGiuongGa - Cập nhật mật khẩu mới';
